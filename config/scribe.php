...
return [
     ...
     */
    'base_url' => config( 'services.api.url' ),
    ...
    'static' => [
         ...
         */
        'output_path' => 'public/v1/f2aow5azkp',
    ],
    ...
    'auth' => [
         ...
         */
        'extra_info' => 'When running <code>artisan serve</code> in your localhost, please add port 8000 or whatever port assigned behind the localhost',
    ],

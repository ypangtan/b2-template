        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control form-control-sm" id="{{ $product_edit }}_sku"></input>
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control form-control-sm" id="{{ $product_edit }}_title"></input>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
                <div class="mb-3 row">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control form-control-sm" id="{{ $product_edit }}_regular_price"></input>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control form-control-sm" id="{{ $product_edit }}_taxable"></input>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control form-control-sm" id="{{ $product_edit }}_promo_price"></input>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="{{ $product_edit }}_promo_price_from" class="col-sm-5 col-form-label">{{ __( 'product.promo_price_from' ) }}</label>
                    <div class="col-sm-7">
                        <input type="text" class="form-control form-control-sm" id="{{ $product_edit }}_promo_price_from"></input>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="{{ $product_edit }}_promo_price_to" class="col-sm-5 col-form-label">{{ __( 'product.promo_price_to' ) }}</label>
                    <div class="col-sm-7">
                        <input type="text" class="form-control form-control-sm" id="{{ $product_edit }}_promo_price_to"></input>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control form-control-sm" id="{{ $product_edit }}_quantity"></input>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control form-control-sm" id="{{ $product_edit }}_friendly_url"></input>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control form-control-sm" id="{{ $product_edit }}_meta_title"></input>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
                <div class="mb-3 row">

    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="text-end">
                    <button id="{{ $role_create }}_cancel" type="button" class="btn btn-sm btn-outline-secondary">{{ __( 'template.cancel' ) }}</button>
                    &nbsp;
                    <button id="{{ $role_create }}_submit" type="button" class="btn btn-sm btn-success">{{ __( 'template.save_changes' ) }}</button>
                </div>
            </div>
        </div>
    </div>

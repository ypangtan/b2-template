...
class CreateUserNotificationSeensTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('user_notification_seens', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('user_notification_seens');
    }
}
